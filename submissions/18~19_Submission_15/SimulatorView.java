...
public class SimulatorView extends JFrame
{
    ...
    private JLabel stepLabel, population, infoLabel, hourLabel, weatherLabel;
     ...
     * @param currentTime The time to be displayed.
     */

    public void showStatus(int step, Field field, int currentTime)
    {
        if(!isVisible()) {
            setVisible(true);
        }
        ...
        hourLabel.setText(HOUR_PREFIX + currentTime + ":00");
        stats.reset();

        weatherLabel.setText(WEATHER_PREFIX + Simulator.getCurrentWeather());
        stats.reset();
        ...
        for(int row = 0; row < field.getDepth(); row++) {
            for(int col = 0; col < field.getWidth(); col++) {
                ...
                if(animal != null) {
                    ...
                    else if (Simulator.isEvening() || Simulator.isMorning()) {
                        fieldView.drawMark(col, row, UNKNOWN_COLOR);
                    }
                    else if (!(Simulator.isDay())) {
